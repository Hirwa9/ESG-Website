...
<body class="bg-bodi" data-spy="scroll" data-bs-target=".navbar" data-offset="20">
    ...
    <script>
        // const fName = "Ndayizeye";
        // const lName = "Aline";
        // const imageLink = "../../Pics/AlineU_1.png";
        // const status = { gender: "female", roles: ["singer", "section leader", "acountant"], voice: "soprano" };
        // const otherChoirsDetails = [
        //     {choirName: "Regina Pacis(Abizera) Choir", choirLocation: "Rutonde Parish - Kigali Archdiocese"},
        //     {choirName: "St. Vincent Choir", choirLocation: "St. Peter Parish - Kigali Archdiocese"}
        // ];
        // const email = "alinendayizeye@gmail.com";
        // const password = "pass";

        // console.log(JSON.stringify(status));
        // console.log(JSON.stringify(otherChoirsDetails));
    ...
    <div class="bg-myBlue show-touch-sm isolate-y px-1 fix-draggable webSettings">
		<button class="fa fa-close d-block w-2_5rem ratio-1-1 flex-center border-1 rounded-pill bg-transparent text-appColor-cons ms-auto ms-sm-0 me-sm-auto" onclick="hide_web_settings()"></button>
		<div class="touch-anim"></div>
		<h5 class="text-center fix-dragger fs-3">Web settings</h5>
        ...
        <div class="d-md-flex">
            <div class="p-2 p-sm-5 col-md-8 d-grid">
                <div class="grid-center">
                    <div class="mb-5 mb-md-0 display-3 fw-bold text-primary">Soprano</div>
                </div>
                <ul class="list-group list-group-horizontal" style="align-self: last baseline;">
                    <li class="list-group-item borderless active" aria-current="true">Soprano</li>
                    <li class="list-group-item bg-none borderless"><a href="ESG_Alto.php">Alto</a></li>
                    <li class="list-group-item bg-none borderless"><a href="ESG_Tenor.php">Tenor</a></li>
                    <li class="list-group-item bg-none borderless"><a href="ESG_Bass.php">Bass</a></li>
                  </ul>
            </div>
            <div class="p-5 col-md-4">
                A soprano voice is a term used in music to describe the highest vocal range for female singers. Soprano singers typically have the highest-pitched voices in choral and operatic music. They can sing notes in the higher register and often have the ability to hit very high and piercing notes with clarity and power.
            </div>
        </div>
    </div>
    <div class="voice-members">
        ...
        foreach ($voiceMembers as $member) {
            ...
            if (in_array("section leader", $status->roles)) {
                ...
                $leaderImage = json_decode($personProps)->imageURL;
            }
        }
        if ($leaderName !== null) {
            echo <<<HTML
            <div class="d-sm-flex col-sm-10 offset-sm-1 mb-4">
                <img src="{$leaderImage}" alt="Section leader" style="width: clamp(15rem, 150vw, 30%);" class="ms-auto me-5 img-thumbnail rounded-circle bg-black2">
                <div class="p-3">
                    <h2>Section leader</h2>
                    <p>
                        <mark class="fw-bold">{$leaderName}</mark> is the section leader of {$voiceType} in our group.<br><br>
                        Our {$voiceType} section is made of {$totalVoiceMembers} active singers.
                    </p>
                </div>
            </div>
            <hr>
        ...
        <div class="row m-0 mb-4 p-md-5">
            ...
            foreach ($voiceMembers as $member) {
                ...
                json_decode($status)->gender == "male" ? $pronoun = "he" : $pronoun = "she";
